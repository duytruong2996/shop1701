          ...
          <ul>
            ...
            <li data-transition="slidehorizontal" data-slotamount="5" data-masterspeed="700">
              ...
              <div class="tp-caption very_big_white skewfromrightshort fadeout" data-x="center" data-y="100" data-speed="500" data-start="1200"
                data-easing="Circ.easeInOut" style=" font-size:70px; font-weight:800; color:#fe0100;"><?=$slide->title?>
                    ...
                    <div class="slider-items-products">
                      <div id="featured-slider" class="product-flexslider hidden-buttons">
                        <div class="slider-items slider-width-col4">
                          <?php foreach($featureProducts as $p):?>
              ...
              <div class="jtv-product jtv-cat-margin">
                ...
                <div class="jtv-product-content">
                  ...
                  <? if($bestSeller[$i]->promotion_price ==0):?>
                      <span class="regular-price">
                        <span class="price"><?=number_format($bestSeller[$i]->price)?> vnd</span>
                      </span>
                      <? else:?>
                      <p class="special-price">
                        <span class="price-label">Special Price</span>
                        <span class="price"><?=number_format($bestSeller[$i]->promotion_price)?> vnd</span>
                      </p>
                      <br>
                      <p class="old-price">
                        <span class="price-label">Regular Price:</span>
